  ...
  return (
    <DashboardLayout role="teacher">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          <h3 className="text-lg font-semibold text-gray-900">Lecciones Creadas</h3>
          ...
          <div className="border rounded-lg p-4 hover:shadow-md transition-shadow">
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600 mb-2">Estudiantes: 24</p>
                <div className="mb-2">
                  <span className="inline-block bg-green-100 text-green-800 text-xs px-2 py-1 rounded">
                    Publicado
                  </span>
                </div>
                <button className="text-sm text-indigo-600 hover:text-indigo-700 font-medium mr-3">
                  Ver Detalles
                </button>
          ...
          <div className="border rounded-lg p-4 hover:shadow-md transition-shadow">
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600 mb-2">Estudiantes: 32</p>
                <div className="mb-2">
                  <span className="inline-block bg-green-100 text-green-800 text-xs px-2 py-1 rounded">
                    Publicado
                  </span>
      ...
      <div className="bg-white rounded-lg shadow-sm border p-6">
        ...
        <div className="space-y-4">
          {[
            { action: 'Creó una nueva lección', course: 'Fe y Ciencia', time: 'Hace 1 hora' },
            { action: 'Actualizó el contenido del curso', course: 'Fundamentos de la Fe Cristiana', time: 'Hace 2 días' },
            { action: 'Revisó certificados', course: 'Introducción a la Biblia', time: 'Hace 1 semana' }
          ].map((activity, index) => (
